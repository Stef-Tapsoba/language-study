...
//
// ID FIX (2026-03-25): All unit IDs now match their order numbers (id: "ja-a1-uN" = order: N).
// Previously mismatched: U19→U7, U7→U8, U8→U9, U9→U10, U10→U11, U20→U12, U11→U13,
// U12→U14, U13→U15, U14→U16, U15→U17, U16→U18, U17→U19, U18→U20. Test question IDs
// updated accordingly (ja-uq-a1-N-M where N = unit order). All 27 IDs and question prefixes
// now consistent.
//
// RADICALS LESSON (2026-03-25): ja-g-a1-40 "Kanji Radicals (部首) — How Kanji Are Built"
// added to U20 grammarIds between ja-g-a1-39 and ja-g-a1-14. Covers 15 key N5 radicals,
// meaning-guessing strategies, and worked examples (好き, 休む, 明るい).
//
...
// U10 — Past Tense: ました
// U11 — Negation & Questions
// U12 — Adjective Conjugation: い and な
// U13 — を Particle
// U14 — に Particle + あります/います
// U15 — で Particle
// U16 — が vs は
// U17 — Food & Shopping Vocabulary
// U18 — Likes & Dislikes: 好き / 嫌い
// U19 — Wanting To Do: 〜たい
// U20 — N5 Kanji Part 1 — Why Kanji + Radicals + Numbers, Time, Nature & Position  (+ja-g-a1-40)
...
// U24 — New Particles: も, と, から, まで
// U25 — て-form, Plain Form & Suggestions
// U26 — N5 Kanji Part 2 — People, Actions, Places & Society
...
export const a1Units: LessonUnit[] = [
    ...
    },
    {
        ...
        verbIds: [],
        testQuestions: [
            { id: "ja-uq-a1-7-1", level: "A1", prompt: "How do you say 'this book'?", options: ["あの本", "その本", "この本", "どの本"], answer: "この本" },
            { id: "ja-uq-a1-7-2", level: "A1", prompt: "Which demonstrative refers to something far from BOTH speaker and listener?", options: ["これ", "それ", "あれ", "どれ"], answer: "あれ" },
            { id: "ja-uq-a1-7-3", level: "A1", prompt: "How do you ask 'Whose bag is this?'", options: ["これは なんの かばんですか？", "これは だれの かばんですか？", "これは どこの かばんですか？", "これは いくらの かばんですか？"], answer: "これは だれの かばんですか？" },
            { id: "ja-uq-a1-7-4", level: "A1", prompt: "How do you say 'my teacher' using の?", options: ["わたしで せんせい", "わたしに せんせい", "わたしの せんせい", "わたしを せんせい"], answer: "わたしの せんせい" },
            { id: "ja-uq-a1-7-5", level: "A1", prompt: "What does あそこ mean?", options: ["Here", "There (near you)", "Over there (far)", "Where?"], answer: "Over there (far)" },
            { id: "ja-uq-a1-7-6", level: "A1", prompt: "How do you say 'It's mine' (using の alone)?", options: ["わたしです。", "わたしのです。", "わたしにです。", "わたしがです。"], answer: "わたしのです。" },
        ]
    },
    {
        id: "ja-a1-u8",
        ...
        verbIds: ["ja-vb-a1-11"],
        testQuestions: [
            { id: "ja-uq-a1-8-1", level: "A1", prompt: "What counter is used for generic objects (1-9)?", options: ["つ", "本", "枚", "人"], answer: "つ" },
            { id: "ja-uq-a1-8-2", level: "A1", prompt: "How do you say 'two people'?", options: ["ににん", "ふたり", "にほん", "ふたつ"], answer: "ふたり" },
            { id: "ja-uq-a1-8-3", level: "A1", prompt: "Which counter is used for bottles, pens, and trees?", options: ["つ", "枚", "本", "杯"], answer: "本" },
            { id: "ja-uq-a1-8-4", level: "A1", prompt: "How do you say 'one cup of coffee'?", options: ["コーヒーをひとつ", "コーヒーを一本", "コーヒーを一杯", "コーヒーを一枚"], answer: "コーヒーを一杯" },
            { id: "ja-uq-a1-8-5", level: "A1", prompt: "Which counter is used for flat thin things like paper, tickets, and shirts?", options: ["本", "杯", "つ", "枚"], answer: "枚" },
            { id: "ja-uq-a1-8-6", level: "A1", prompt: "How do you say 'I ate three apples'?", options: ["りんごを三本食べました。", "りんごを三枚食べました。", "りんごを三つ食べました。", "りんごを三人食べました。"], answer: "りんごを三つ食べました。" },
        ]
    },
    {
        id: "ja-a1-u9",
        ...
        testQuestions: [
            { id: "ja-uq-a1-9-1", level: "A1", prompt: "What is the polite present form of 食べる (taberu)?", options: ["食べた", "食べます", "食べません", "食べて"], answer: "食べます" },
            { id: "ja-uq-a1-9-2", level: "A1", prompt: "What is the polite present form of 行く (iku)?", options: ["行きます", "行く", "行って", "行きた"], answer: "行きます" },
            { id: "ja-uq-a1-9-3", level: "A1", prompt: "The irregular verb する (suru) becomes which ます-form?", options: ["するます", "すります", "します", "しいます"], answer: "します" },
            { id: "ja-uq-a1-9-4", level: "A1", prompt: "How do you say 'I am eating right now' using 〜ています?", options: ["たべます。", "たべました。", "たべています。", "たべてください。"], answer: "たべています。" },
            { id: "ja-uq-a1-9-5", level: "A1", prompt: "What kind of actions does ます-form express?", options: ["Past actions only", "Present habits and future actions (polite)", "Commands only", "Wishes only"], answer: "Present habits and future actions (polite)" },
            { id: "ja-uq-a1-9-6", level: "A1", prompt: "How do you say 'I live in Tokyo' (resultant state)?", options: ["とうきょうに いきます。", "とうきょうに すんでいます。", "とうきょうに いました。", "とうきょうに いてください。"], answer: "とうきょうに すんでいます。" },
            { id: "ja-uq-a1-9-7", level: "A1", prompt: "What does '〜ています' express with a change-of-state verb like 結婚する?", options: ["The action is happening right now", "The ongoing result of a completed action", "A future intention", "A polite request"], answer: "The ongoing result of a completed action" },
        ]
    },
    {
        id: "ja-a1-u10",
        ...
        testQuestions: [
            ...
            { id: "ja-uq-a1-10-3", level: "A1", prompt: "What is the past form of 来ます (kimasu)?", options: ["来ません", "来ました", "来まして", "来ましょう"], answer: "来ました" },
            { id: "ja-uq-a1-10-4", level: "A1", prompt: "How do you say 'She did not come'?", options: ["来ました。", "来ません。", "来ませんでした。", "来て。"], answer: "来ませんでした。" },
            { id: "ja-uq-a1-10-5", level: "A1", prompt: "What is the past copula (was/were) in polite Japanese?", options: ["です", "でした", "でしょう", "ですか"], answer: "でした" },
            { id: "ja-uq-a1-10-6", level: "A1", prompt: "How do you say 'I watched TV last night'?", options: ["昨日の夜、テレビを見ます。", "昨日の夜、テレビを見ました。", "昨日の夜、テレビを見ません。", "昨日の夜、テレビを見て。"], answer: "昨日の夜、テレビを見ました。" },
        ]
    },
    {
        id: "ja-a1-u11",
        ...
        testQuestions: [
            { id: "ja-uq-a1-11-1", level: "A1", prompt: "How do you say 'I don't speak Japanese'?", options: ["日本語を話します。", "日本語を話しません。", "日本語を話しました。", "日本語を話すか？"], answer: "日本語を話しません。" },
            { id: "ja-uq-a1-11-2", level: "A1", prompt: "What question word means 'where'?", options: ["なに", "いつ", "どこ", "だれ"], answer: "どこ" },
            { id: "ja-uq-a1-11-3", level: "A1", prompt: "How do you ask 'What is your name?' in Japanese?", options: ["お名前はどこですか？", "お名前はいつですか？", "お名前は何ですか？", "お名前はだれですか？"], answer: "お名前は何ですか？" },
            { id: "ja-uq-a1-11-4", level: "A1", prompt: "What is the question word for 'when'?", options: ["どれ", "いつ", "なに", "どう"], answer: "いつ" },
            { id: "ja-uq-a1-11-5", level: "A1", prompt: "How do you say 'I do not write letters'?", options: ["手紙を書きます。", "手紙を書きました。", "手紙を書きません。", "手紙を書いて。"], answer: "手紙を書きません。" },
            { id: "ja-uq-a1-11-6", level: "A1", prompt: "Where does the question particle か go in a sentence?", options: ["At the beginning", "Before the verb", "After the subject", "At the end of the sentence"], answer: "At the end of the sentence" },
        ]
    },
    {
        id: "ja-a1-u12",
        ...
        vocabIds: ["ja-v-a1-172"],
        verbIds: ["ja-vb-a1-43"],
        testQuestions: [
            { id: "ja-uq-a1-12-1", level: "A1", prompt: "What is the negative form of おいしい (delicious)?", options: ["おいしいじゃないです", "おいしくないです", "おいしかったです", "おいしくなかったです"], answer: "おいしくないです" },
            { id: "ja-uq-a1-12-2", level: "A1", prompt: "What is the past form of さむい (cold)?", options: ["さむいでした", "さむかったです", "さむくないです", "さむじゃなかったです"], answer: "さむかったです" },
            { id: "ja-uq-a1-12-3", level: "A1", prompt: "What is the EXCEPTION to い-adjective conjugation?", options: ["おおきい", "たかい", "いい (good)", "おいしい"], answer: "いい (good)" },
            { id: "ja-uq-a1-12-4", level: "A1", prompt: "How do you say 'a quiet room' (しずか + 部屋)?", options: ["しずかい部屋", "しずかな部屋", "しずかの部屋", "しずかで部屋"], answer: "しずかな部屋" },
            { id: "ja-uq-a1-12-5", level: "A1", prompt: "What is the past negative of いい (good)?", options: ["いくなかったです", "よかったです", "よくなかったです", "いじゃなかったです"], answer: "よくなかったです" },
            { id: "ja-uq-a1-12-6", level: "A1", prompt: "What ending does a な-adjective take BEFORE a noun?", options: ["い", "の", "な", "で"], answer: "な" },
        ]
    },
    {
        id: "ja-a1-u13",
        ...
        testQuestions: [
            { id: "ja-uq-a1-13-1", level: "A1", prompt: "What is the function of the particle を (wo)?", options: ["Marks the topic", "Marks the subject", "Marks the direct object", "Marks the location"], answer: "Marks the direct object" },
            { id: "ja-uq-a1-13-2", level: "A1", prompt: "Which sentence is correct for 'I eat rice'?", options: ["ご飯は食べます。", "ご飯が食べます。", "ご飯に食べます。", "ご飯を食べます。"], answer: "ご飯を食べます。" },
            { id: "ja-uq-a1-13-3", level: "A1", prompt: "How do you say 'I watch TV'?", options: ["テレビが見ます。", "テレビを見ます。", "テレビは見ます。", "テレビに見ます。"], answer: "テレビを見ます。" },
            { id: "ja-uq-a1-13-4", level: "A1", prompt: "What does 'みずを飲みます' mean?", options: ["I go to the water.", "I drink water.", "The water is good.", "Water, please."], answer: "I drink water." },
            { id: "ja-uq-a1-13-5", level: "A1", prompt: "How do you say 'I write a letter'?", options: ["手紙に書きます。", "手紙は書きます。", "手紙を書きます。", "手紙が書きます。"], answer: "手紙を書きます。" },
        ]
    },
    {
        id: "ja-a1-u14",
        ...
        testQuestions: [
            ...
            { id: "ja-uq-a1-14-3", level: "A1", prompt: "How do you say 'I wake up at seven o'clock'?", options: ["七時で起きます。", "七時を起きます。", "七時に起きます。", "七時が起きます。"], answer: "七時に起きます。" },
            { id: "ja-uq-a1-14-4", level: "A1", prompt: "Which sentence correctly uses に for location of existence?", options: ["公園で子供がいます。", "公園に子供がいます。", "公園を子供がいます。", "公園が子供がいます。"], answer: "公園に子供がいます。" },
            { id: "ja-uq-a1-14-5", level: "A1", prompt: "に is NOT used with which type of time word?", options: ["三時 (three o'clock)", "月曜日 (Monday)", "今日 (today)", "六月 (June)"], answer: "今日 (today)" },
            { id: "ja-uq-a1-14-6", level: "A1", prompt: "How do you say 'I came to Japan'?", options: ["日本で来ました。", "日本を来ました。", "日本に来ました。", "日本が来ました。"], answer: "日本に来ました。" },
        ]
    },
    {
        id: "ja-a1-u15",
        ...
        testQuestions: [
            { id: "ja-uq-a1-15-1", level: "A1", prompt: "Which particle marks where an action takes place?", options: ["に", "が", "で", "の"], answer: "で" },
            { id: "ja-uq-a1-15-2", level: "A1", prompt: "How do you say 'I study at the library'?", options: ["図書館に勉強します。", "図書館で勉強します。", "図書館を勉強します。", "図書館が勉強します。"], answer: "図書館で勉強します。" },
            { id: "ja-uq-a1-15-3", level: "A1", prompt: "How do you say 'I come by bus'?", options: ["バスに来ます。", "バスが来ます。", "バスで来ます。", "バスを来ます。"], answer: "バスで来ます。" },
            { id: "ja-uq-a1-15-4", level: "A1", prompt: "What is the difference between に and で for locations?", options: ["に and で mean the same thing", "に marks where you exist/go to; で marks where you do something", "に marks actions; で marks existence", "There is no difference"], answer: "に marks where you exist/go to; で marks where you do something" },
            { id: "ja-uq-a1-15-5", level: "A1", prompt: "How do you say 'Please speak in Japanese'?", options: ["日本語に話してください。", "日本語が話してください。", "日本語で話してください。", "日本語を話してください。"], answer: "日本語で話してください。" },
            { id: "ja-uq-a1-15-6", level: "A1", prompt: "How do you say 'I eat at the restaurant'?", options: ["レストランに食べます。", "レストランで食べます。", "レストランを食べます。", "レストランが食べます。"], answer: "レストランで食べます。" },
        ]
    },
    {
        id: "ja-a1-u16",
        ...
        testQuestions: [
            { id: "ja-uq-a1-16-1", level: "A1", prompt: "What does は (wa) signal in a sentence?", options: ["New information or focus", "The topic — what the sentence is about", "The direct object", "A question"], answer: "The topic — what the sentence is about" },
            { id: "ja-uq-a1-16-2", level: "A1", prompt: "How do you say 'Who came?' and answer it?", options: ["だれはきましたか？ — たなかさんはきました。", "だれがきましたか？ — たなかさんがきました。", "だれをきましたか？ — たなかさんをきました。", "だれにきましたか？ — たなかさんにきました。"], answer: "だれがきましたか？ — たなかさんがきました。" },
            { id: "ja-uq-a1-16-3", level: "A1", prompt: "Which particle is ALWAYS used with すき (like) and きらい (dislike)?", options: ["を", "は", "に", "が"], answer: "が" },
            { id: "ja-uq-a1-16-4", level: "A1", prompt: "What does は imply when used with a preference sentence like 'コーヒーはすきです'?", options: ["Strong emphasis on coffee", "A contrast — I like coffee (but maybe not other things)", "That coffee is the subject of the sentence", "Past tense"], answer: "A contrast — I like coffee (but maybe not other things)" },
            { id: "ja-uq-a1-16-5", level: "A1", prompt: "When do you use が instead of は?", options: ["Always, when in doubt", "When stating new information, answering 'who/what', or with すき/きらい/わかる", "For all location sentences", "Only in questions"], answer: "When stating new information, answering 'who/what', or with すき/きらい/わかる" },
        ]
    },
    {
        id: "ja-a1-u17",
        ...
        testQuestions: [
            ...
            { id: "ja-uq-a1-17-3", level: "A1", prompt: "What does 'たかい' mean?", options: ["Cheap / Inexpensive", "Expensive / Tall / High", "Small", "Old"], answer: "Expensive / Tall / High" },
            { id: "ja-uq-a1-17-4", level: "A1", prompt: "What is 'fish' in Japanese?", options: ["にく", "さかな", "たまご", "やさい"], answer: "さかな" },
            { id: "ja-uq-a1-17-5", level: "A1", prompt: "What does 'あたらしい' mean?", options: ["Old", "Big", "New", "Good"], answer: "New" },
            { id: "ja-uq-a1-17-6", level: "A1", prompt: "What is 'egg' in Japanese?", options: ["たまご", "さかな", "にく", "ぎゅうにゅう"], answer: "たまご" },
        ]
    },
    {
        id: "ja-a1-u18",
        ...
        vocabIds: [
            ...
            "ja-v-a1-70", "ja-v-a1-138", "ja-v-a1-148", "ja-v-a1-177",
        ],
        verbIds: [],
        testQuestions: [
            { id: "ja-uq-a1-18-1", level: "A1", prompt: "How do you say 'I like coffee'?", options: ["コーヒーを好きです。", "コーヒーが好きです。", "コーヒーは好きです。", "コーヒーに好きです。"], answer: "コーヒーが好きです。" },
            { id: "ja-uq-a1-18-2", level: "A1", prompt: "How do you say 'I dislike fish'?", options: ["さかなが好きです。", "さかなを嫌いです。", "さかなが嫌いです。", "さかなは嫌いです。"], answer: "さかなが嫌いです。" },
            { id: "ja-uq-a1-18-3", level: "A1", prompt: "What particle marks the thing you like in Japanese?", options: ["を", "は", "に", "が"], answer: "が" },
            { id: "ja-uq-a1-18-4", level: "A1", prompt: "How do you say 'I love sushi'?", options: ["すしが好きです。", "すしが大好きです。", "すしが嫌いです。", "すしをとても好きです。"], answer: "すしが大好きです。" },
            { id: "ja-uq-a1-18-5", level: "A1", prompt: "How do you ask 'Do you like sport?'", options: ["スポーツをしますか？", "スポーツが好きですか？", "スポーツは好きですか？", "スポーツが嫌いですか？"], answer: "スポーツが好きですか？" },
            { id: "ja-uq-a1-18-6", level: "A1", prompt: "What does 大好き (daisuki) express?", options: ["Slight liking", "Dislike", "Neutral feeling", "Strong liking / love"], answer: "Strong liking / love" },
        ]
    },
    {
        id: "ja-a1-u19",
        ...
        testQuestions: [
            ...
            { id: "ja-uq-a1-19-3", level: "A1", prompt: "How do you say 'I want to go to Japan'?", options: ["日本に行きます。", "日本に行きたいです。", "日本に行きました。", "日本に行きません。"], answer: "日本に行きたいです。" },
            { id: "ja-uq-a1-19-4", level: "A1", prompt: "What is the negative form of たいです?", options: ["たくないです", "たいじゃないです", "たいません", "たいでした"], answer: "たくないです" },
            { id: "ja-uq-a1-19-5", level: "A1", prompt: "How do you ask 'What do you want to do?'", options: ["何をしましたか？", "何がしたいですか？", "何をしますか？", "何をしていますか？"], answer: "何がしたいですか？" },
            { id: "ja-uq-a1-19-6", level: "A1", prompt: "たい can be used to express which person's desires directly?", options: ["Any person", "Third person only", "First person (speaker) only", "Second person only"], answer: "First person (speaker) only" },
        ]
    },
    {
        id: "ja-a1-u20",
        ...
        grammarIds: ["ja-g-a1-39", "ja-g-a1-40", "ja-g-a1-14"],
        vocabIds: [
            ...
            "ja-v-a1-171",  // 海 (うみ) — sea / ocean (nature kanji)
        ],
        verbIds: [],
        testQuestions: [
            { id: "ja-uq-a1-20-1", level: "A1", prompt: "What does the kanji 日 mean?", options: ["Water", "Mountain", "Sun / Day", "Person"], answer: "Sun / Day" },
            { id: "ja-uq-a1-20-2", level: "A1", prompt: "What does 日本 (にほん) mean?", options: ["Japanese language", "Japanese person", "Japan", "Japanese food"], answer: "Japan" },
            { id: "ja-uq-a1-20-3", level: "A1", prompt: "What does 先生 (せんせい) mean?", options: ["Student", "University", "Teacher", "Language"], answer: "Teacher" },
            { id: "ja-uq-a1-20-4", level: "A1", prompt: "Which kanji means 'study / learning'?", options: ["生", "先", "学", "語"], answer: "学" },
            { id: "ja-uq-a1-20-5", level: "A1", prompt: "What does 大学 (だいがく) mean?", options: ["Big person", "University", "Teacher", "Study group"], answer: "University" },
            { id: "ja-uq-a1-20-6", level: "A1", prompt: "Which kanji means 'above / up'?", options: ["下", "中", "小", "上"], answer: "上" },
            { id: "ja-uq-a1-20-7", level: "A1", prompt: "What does 学生 (がくせい) mean?", options: ["Teacher", "School", "Student", "Language"], answer: "Student" },
            { id: "ja-uq-a1-20-8", level: "A1", prompt: "What is the kun'yomi reading of 水?", options: ["すい", "みず", "みな", "こう"], answer: "みず" },
        ]
    },
    {
        id: "ja-a1-u21",
        ...
        vocabIds: [],
        verbIds: ["ja-vb-a1-31", "ja-vb-a1-42", "ja-vb-a1-44"],
        testQuestions: [
