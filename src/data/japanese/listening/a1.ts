// src/data/japanese/listening/a1.ts
...
export const a1Listening: ListeningExercise[] = [
        ...
        questions: [
            {
                id: "ja-l-a1-1-q1",
                level: "A1",
                prompt: "Where is Tanaka Hiroshi from?",
            ...
            },
            {
                id: "ja-l-a1-1-q2",
                level: "A1",
                prompt: "What does Tanaka do?",
                options: ["He is a student", "He is a company employee", "He is a teacher", "He is a doctor"],
                answer: "He is a student"
            },
            {
                id: "ja-l-a1-1-q3",
                level: "A1",
                prompt: "What is Sato Keiko's occupation?",
                options: ["Company employee", "Student", "Teacher", "Doctor"],
        ...
        questions: [
            {
                ...
                options: ["100 yen", "150 yen", "250 yen", "200 yen"],
                answer: "100 yen"
            },
            {
                id: "ja-l-a1-2-q2",
                level: "A1",
                prompt: "How much does the customer pay in total?",
                options: ["550 yen", "300 yen", "750 yen", "1,000 yen"],
                answer: "550 yen"
            },
            {
                id: "ja-l-a1-2-q3",
                ...
                options: ["450 yen", "500 yen", "350 yen", "150 yen"],
                answer: "450 yen"
            }
        ]
    },
    {
        ...
        questions: [
            ...
            },
            {
                id: "ja-l-a1-3-q3",
                level: "A1",
                prompt: "What time is the next train?",
    ...
    },
    {
        id: "ja-l-a1-4",
        level: "A1",
        title: "かぞくのしょうかい — introducing family",
        script: "わたしのかぞくをしょうかいします。ちちはよんじゅうごさいです。かいしゃいんです。はははよんじゅうさんさいです。せんせいです。あねはにじゅういっさいです。だいがくせいです。いもうとはじゅうごさいです。こうこうせいです。わたしはじゅうはっさいです。こうこうさんねんせいです。かぞくはみんなげんきです。",
        translation: "I will introduce my family. My father is forty-five years old. He is a company employee. My mother is forty-three years old. She is a teacher. My older sister is twenty-one years old. She is a university student. My younger sister is fifteen years old. She is a high school student. I am eighteen years old. I am a third-year high school student. Everyone in my family is healthy.",
        questions: [
            {
                id: "ja-l-a1-4-q1",
                level: "A1",
                prompt: "What is the speaker's mother's job?",
                options: ["Teacher", "Company employee", "Doctor", "Nurse"],
                answer: "Teacher"
            },
            {
                id: "ja-l-a1-4-q2",
                level: "A1",
                prompt: "How old is the older sister (あね)?",
                options: ["21", "15", "18", "43"],
                answer: "21"
            },
            {
