...
export const block0Lessons: GrammarLesson[] = [
    {
        ...
        examples: [
            ...
            { native: "야", romanized: "ya", translation: "= + extra stroke (vertical → right)", annotation: "ㅑ / ㅏ"},
            { native: "여", romanized: "yeo", translation: "= + extra stroke (vertical → right)", annotation: "ㅕ / ㅓ"},
            { native: "요", romanized: "yo", translation: "= + extra stroke (horizontal → below)", annotation: "ㅛ / ㅗ"},
            { native: "유", romanized: "yu", translation: "= + extra stroke (horizontal → below)", annotation: "ㅠ / ㅜ"},
        ],
        inlineVocab: [
