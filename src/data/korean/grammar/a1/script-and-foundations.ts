...
export const scriptAndFoundationsLessons: GrammarLesson[] = [
    ...
    },
    {
        ...
        examples: [
            { native: "가 = ㄱ + ㅏ", romanized: "ga", speakText: "가", translation: "Consonant ㄱ + vowel ㅏ = syllable block 가" },
            { native: "나 = ㄴ + ㅏ", romanized: "na", speakText: "나", translation: "Consonant ㄴ + vowel ㅏ = syllable block 나" },
            { native: "안 = ㅇ + ㅏ + ㄴ", romanized: "an", speakText: "안", translation: "Silent ㅇ + ㅏ + final consonant ㄴ = 안" },
