// Korean A2 grammar lessons
// data/korean/grammar/a2.ts
...
export const a2Grammar: GrammarLesson[] = [
    {
        ...
        explanation: "To say you want to do something, attach 고 싶어요 to the verb stem. This applies to first-person desires in direct speech. For third-person desires, use 고 싶어하다 (고 싶어해요). To ask about someone's desire, use 고 싶어요? with rising intonation.",
        examples: [
    ...
    },
    {
        ...
        explanation: "To express ability ('can/be able to') use the verb stem + (으)ㄹ 수 있어요. For inability, use 없어요. If the stem ends in a consonant, add 을 수; if it ends in a vowel or ㄹ, add ㄹ 수. This structure is more permanent ability than 못 (situational inability).",
        examples: [
    ...
    },
    {
        ...
        explanation: "To express a future plan or intention, attach (으)ㄹ 거예요 to the verb stem. If the stem ends in a consonant, add 을 거예요. If it ends in a vowel, add ㄹ 거예요. This is the most natural way to express future events in everyday conversation.",
        examples: [
    ...
    },
    {
        ...
        explanation: "Attach 고 있어요 to a verb stem to express an ongoing action ('am/is/are -ing'). The negative is 고 있지 않아요 or simply 안 ~ 고 있어요. This tense focuses on an action in progress at the moment of speaking.",
        examples: [
