...
export const a2Listening: ListeningExercise[] = [
    {
        ...
        dialogue: [
            { speaker: "관광객", speakerLabel: "Tourist", text: "실례합니다. 여기서 사진 찍어도 돼요?", translation: "Excuse me. May I take photos here?" },
            { speaker: "직원", speakerLabel: "Staff", text: "이 방에서는 사진 찍으면 안 돼요. 플래시 사용도 금지예요. 그런데 다음 방에서는 촬영 가능해요.", translation: "In this room you must not take photos. Flash photography is also prohibited. But in the next room photography is permitted." },
            { speaker: "관광객", speakerLabel: "Tourist", text: "아, 알겠어요. 그럼 이 작품 만져도 돼요?", translation: "Ah, I understand. Then may I touch this artwork?" },
            { speaker: "직원", speakerLabel: "Staff", text: "아니요, 만지면 안 돼요. 죄송해요.", translation: "No, you must not touch it. I'm sorry." },
            { speaker: "관광객", speakerLabel: "Tourist", text: "괜찮아요. 그러면 저기 카페에서 음료 마실 수 있어요?", translation: "That's okay. In that case, can I have a drink at the café over there?" },
            { speaker: "직원", speakerLabel: "Staff", text: "네, 물론이죠! 카페에서는 드셔도 돼요.", translation: "Yes, of course! You may eat and drink in the café." },
        ],
        questions: [
    ...
    },
    {
        ...
        dialogue: [
            { speaker: "조교", speakerLabel: "Teaching Assistant", text: "안녕하세요, 한국학과입니다.", translation: "Hello, this is the Korean Studies department." },
            { speaker: "민준", text: "안녕하세요. 저는 이민준이라고 합니다. 혹시 박 교수님 계세요?", translation: "Hello. I'm Lee Minjun. Is Professor Park in by any chance?" },
            { speaker: "조교", speakerLabel: "Teaching Assistant", text: "지금 회의 중이셔서 안 계세요.", translation: "They're in a meeting right now, so they're not available." },
            { speaker: "민준", text: "아, 그렇군요. 혹시 오늘 몇 시에 돌아오실 것 같으세요?", translation: "Ah, I see. Do you know what time they might return today?" },
            { speaker: "조교", speakerLabel: "Teaching Assistant", text: "아마 4시쯤이실 것 같아요.", translation: "It'll probably be around 4 o'clock." },
            ...
            { speaker: "조교", speakerLabel: "Teaching Assistant", text: "네, 전해드릴게요.", translation: "Yes, I'll pass it on." },
            ...
            { speaker: "조교", speakerLabel: "Teaching Assistant", text: "내일 오후 2시에서 4시는 비어 있으신 것 같아요.", translation: "Tomorrow between 2 and 4 PM seems to be free." },
