// src/data/korean/listening/a1.ts
...
export const a1Listening: ListeningExercise[] = [
        ...
        questions: [
            {
                id: "ko-l-a1-1-q1",
                level: "A1",
                prompt: "Where is Choi Jiho from?",
                options: ["Incheon", "Seoul", "Daejeon", "Busan"],
                answer: "Incheon"
            },
            {
                id: "ko-l-a1-1-q2",
                level: "A1",
                prompt: "What does Choi Jiho do?",
                options: ["He is a university student", "He is a teacher", "He is a company employee", "He is a doctor"],
                answer: "He is a university student"
            },
            {
                id: "ko-l-a1-1-q3",
                level: "A1",
                prompt: "What is Yoon Soyeon's job?",
                options: ["Teacher", "Student", "Company employee", "Doctor"],
                answer: "Teacher"
            }
        ]
    },
        ...
        questions: [
            {
                ...
                options: ["500 won", "1,000 won", "2,500 won", "300 won"],
                answer: "500 won"
            },
            {
                id: "ko-l-a1-2-q2",
                ...
                options: ["4,000 won", "3,000 won", "5,000 won", "4,500 won"],
                answer: "4,000 won"
            },
            {
                id: "ko-l-a1-2-q3",
                level: "A1",
                prompt: "How much change does the customer receive?",
                options: ["1,000 won", "500 won", "2,000 won", "No change"],
                answer: "1,000 won"
            }
        ]
    },
        ...
        questions: [
            {
                id: "ko-l-a1-3-q1",
                level: "A1",
                prompt: "What time is it at the start of the conversation?",
                options: ["9:30", "10:00", "9:00", "9:45"],
                answer: "9:30"
            },
            {
                id: "ko-l-a1-3-q2",
                level: "A1",
                prompt: "What time does class start?",
                options: ["10:00", "9:30", "9:45", "10:30"],
                answer: "10:00"
            },
            {
                id: "ko-l-a1-3-q3",
                level: "A1",
                prompt: "What time is the next bus?",
                options: ["9:45", "10:00", "9:30", "9:55"],
                answer: "9:45"
            }
        ]
    },
    {
        id: "ko-l-a1-4",
        level: "A1",
        title: "가족 소개 — introducing family",
        script: "저희 가족을 소개할게요. 아버지는 마흔여섯 살이에요. 회사원이에요. 어머니는 마흔세 살이에요. 간호사예요. 누나는 스물두 살이에요. 대학생이에요. 남동생은 열여섯 살이에요. 고등학생이에요. 저는 열아홉 살이에요. 고등학교 삼 학년이에요. 저희 가족은 모두 건강해요.",
        translation: "I will introduce my family. My father is forty-six years old. He is a company employee. My mother is forty-three years old. She is a nurse. My older sister is twenty-two years old. She is a university student. My younger brother is sixteen years old. He is a high school student. I am nineteen years old. I am a third-year high school student. Everyone in my family is healthy.",
        questions: [
            {
                id: "ko-l-a1-4-q1",
                level: "A1",
                prompt: "What is the speaker's mother's job?",
                options: ["Nurse", "Company employee", "Teacher", "Doctor"],
                answer: "Nurse"
            },
            {
                id: "ko-l-a1-4-q2",
                level: "A1",
                prompt: "How old is the older sister (누나)?",
                options: ["22", "16", "19", "43"],
                answer: "22"
            },
            {
                id: "ko-l-a1-4-q3",
                level: "A1",
                prompt: "What year of high school is the speaker in?",
                options: ["Third year", "First year", "Second year", "They are at university"],
                answer: "Third year"
            }
        ]
    },
