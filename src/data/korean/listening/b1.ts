...
export const b1Listening: ListeningExercise[] = [
    ...
    },
    {
        ...
        dialogue: [
            { speaker: "기자", speakerLabel: "Reporter", text: "안녕하세요. 현재 해외 유학을 준비 중이시라고 들었어요. 어느 나라로 가실 예정인가요?", translation: "Hello. I heard you are currently preparing to study abroad. Which country are you planning to go to?" },
            ...
            { speaker: "기자", speakerLabel: "Reporter", text: "왜 캐나다를 선택하셨나요?", translation: "Why did you choose Canada?" },
            ...
            { speaker: "기자", speakerLabel: "Reporter", text: "준비하면서 어려운 점은 없었나요?", translation: "Were there any difficulties while preparing?" },
            ...
            { speaker: "기자", speakerLabel: "Reporter", text: "유학 가서 가장 기대되는 것은 무엇인가요?", translation: "What are you most looking forward to when you go to study abroad?" },
            ...
            { speaker: "기자", speakerLabel: "Reporter", text: "좋은 경험이 되길 바랍니다. 감사합니다.", translation: "I hope it's a great experience. Thank you." }
        ],
        questions: [
            {
                id: "ko-l-b1-2-q1",
    ...
    },
    {
        ...
        dialogue: [
            { speaker: "선생님", speakerLabel: "Teacher", text: "오늘 환경 문제에 대해 이야기해 볼게요. 먼저 지현 씨, 요즘 가장 심각한 환경 문제가 뭐라고 생각해요?", translation: "Let's talk about environmental issues today. First, Jihyeon, what do you think is the most serious environmental problem these days?" },
            ...
            { speaker: "선생님", speakerLabel: "Teacher", text: "맞아요. 그럼 민철 씨는요?", translation: "That's right. What about you, Mincheol?" },
            ...
            { speaker: "선생님", speakerLabel: "Teacher", text: "두 의견 모두 중요하네요. 그럼 해결책은 뭐가 있을까요?", translation: "Both opinions are important. Then what solutions might there be?" },
            ...
            { speaker: "선생님", speakerLabel: "Teacher", text: "좋은 의견이에요. 환경 문제는 개인과 정부가 함께 노력해야 해결될 수 있어요.", translation: "Good points. Environmental problems can only be solved if individuals and the government make efforts together." }
        ],
        questions: [
