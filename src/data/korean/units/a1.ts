...
export const a1Units: LessonUnit[] = [
    ...
    },
    {
        ...
        level: "A1",
        order: 11,
        title: "My daily routine, and where things are",
        ...
        testQuestions: [
            ...
            { id: "ko-uq-a1-11-5", level: "A1", prompt: "듣다 (listen) is a ㄷ irregular. Its present tense is:", options: ["듣어요", "들어요", "듣아요", "듣해요"], answer: "들어요" },
            { id: "ko-uq-a1-11-6", level: "A1", prompt: "저는 매일 운동해요 — why no 에 after 매일?", options: ["매일 is a relative time word, so it stands alone", "매일 ends in a vowel", "에 is optional everywhere", "매일 is not a time word"], answer: "매일 is a relative time word, so it stands alone" },
        ],
    },
    {
        id: "ko-a1-u12",
        ...
        testQuestions: [
            ...
            { id: "ko-uq-a1-12-2", level: "A1", prompt: "작다 (small) in present tense is:", options: ["작아요", "작어요", "작해요", "작았요"], answer: "작아요" },
            { id: "ko-uq-a1-12-3", level: "A1", prompt: "How do you say 'This is delicious'?", options: ["이거 맛있어요.", "이거 맛있요.", "이거 맛이어요.", "이거 맛있해요."], answer: "이거 맛있어요." },
            { id: "ko-uq-a1-12-4", level: "A1", prompt: "가방이 너무 비싸요 means:", options: ["The bag is very pretty.", "The bag is too expensive.", "I don't like the bag.", "The bag is too small."], answer: "The bag is too expensive." },
        ],
    },
    {
        id: "ko-a1-u12b",
        ...
        testQuestions: [
            ...
            { id: "ko-uq-a1-12b-5", level: "A1", prompt: "크다 (big) is a ㅡ-drop irregular. Its present tense is:", options: ["크아요", "크어요", "커요", "크요"], answer: "커요" },
            { id: "ko-uq-a1-12b-6", level: "A1", prompt: "어렵지만 재미있어요 means:", options: ["It's easy and boring.", "It's difficult but interesting.", "It's not difficult or interesting.", "It's interesting so it's difficult."], answer: "It's difficult but interesting." },
        ],
    },
