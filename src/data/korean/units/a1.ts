...
// 15 ordered A1 units for Korean.
//
...
export const a1Units: LessonUnit[] = [
    ...
    },
    {
        ...
        testQuestions: [
            { id: "ko-uq-a1-15-1", level: "A1", prompt: "How do you say 'I went to school yesterday'?", options: ["어제 학교에 가요.", "어제 학교에서 갔어요.", "어제 학교에 갔어요.", "어제 학교를 갔어요."], answer: "어제 학교에 갔어요." },
            { id: "ko-uq-a1-15-2", level: "A1", prompt: "Complete: '저는 한국 음식___ 좋아해요.' (I like Korean food)", options: ["이", "가", "을", "는"], answer: "을" },
            { id: "ko-uq-a1-15-3", level: "A1", prompt: "What does '어제' mean?", options: ["Today", "Tomorrow", "Yesterday", "Now"], answer: "Yesterday" },
            { id: "ko-uq-a1-15-4", level: "A1", prompt: "How do you say 'It is snowing'? (눈 = snow)", options: ["눈이 와요.", "눈이 있어요.", "눈이 가요.", "눈이 많아요."], answer: "눈이 와요." },
            { id: "ko-uq-a1-15-5", level: "A1", prompt: "Which particle is used to mark where an action takes place?", options: ["에", "에서", "을/를", "은/는"], answer: "에서" },
            { id: "ko-uq-a1-15-6", level: "A1", prompt: "How do you say 'I study at the café'?", options: ["카페에 공부해요.", "카페에서 공부해요.", "카페를 공부해요.", "카페가 공부해요."], answer: "카페에서 공부해요." },
        ]
    },
]