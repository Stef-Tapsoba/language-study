...
export const a1Reading: ReadingPassage[] = [
    ...
    },
    {
        ...
        title: "En el café",
        body: {
            target: "Camarero: Buenos días. ¿Qué desea?\nCliente: Buenos días. Quiero un café con leche, por favor.\nCamarero: ¿Grande o pequeño?\nCliente: Pequeño, por favor. ¿Tiene croissants?\nCamarero: Sí, tenemos croissants y también tenemos bocadillos.\nCliente: Un croissant, por favor. ¿Cuánto es?\nCamarero: El café con leche es dos euros y el croissant es uno cincuenta.\nCliente: Aquí tiene tres euros cincuenta.\nCamarero: Gracias. ¡Que aproveche!\nCliente: Gracias. ¡Hasta luego!",
            native: "Waiter: Good morning. What would you like?\nCustomer: Good morning. I'd like a white coffee, please.\nWaiter: Large or small?\nCustomer: Small, please. Do you have croissants?\nWaiter: Yes, we have croissants and we also have sandwiches.\nCustomer: A croissant, please. How much is it?\nWaiter: The white coffee is two euros and the croissant is one fifty.\nCustomer: Here is three euros fifty.\nWaiter: Thank you. Enjoy your meal!\nCustomer: Thank you. Goodbye!"
        },
        vocabGloss: [
    ...
    },
    {
        ...
        body: {
            target: "Turista: Perdona, ¿puedes ayudarme? Busco el centro de la ciudad.\nLocal: Sí, claro. ¿Estás en la estación de tren ahora?\nTurista: Sí, estoy aquí en la estación.\nLocal: Bien. Sal de la estación y ve todo recto por la Calle Mayor.\nTurista: ¿Todo recto por la Calle Mayor?\nLocal: Sí, todo recto. Al final de la calle hay una plaza grande.\nTurista: ¿Y luego?\nLocal: En la plaza, gira a la derecha. Hay una farmacia al lado de la plaza.\nTurista: ¿A la derecha, al lado de la farmacia?\nLocal: Exacto. Después, sigue todo recto y gira a la izquierda en la segunda calle.\nTurista: ¿En la segunda calle a la izquierda?\nLocal: Sí. El centro está enfrente de la iglesia. No puedes perderte.\nTurista: Muchas gracias. ¡Eres muy amable!",
            native: "Tourist: Excuse me, can you help me? I'm looking for the town centre.\nLocal: Yes, of course. Are you at the train station now?\nTourist: Yes, I'm here at the station.\nLocal: Good. Leave the station and go straight ahead along Calle Mayor.\nTourist: Straight ahead along Calle Mayor?\nLocal: Yes, straight ahead. At the end of the street there is a large square.\nTourist: And then?\nLocal: At the square, turn right. There is a pharmacy next to the square.\nTourist: Turn right, next to the pharmacy?\nLocal: Exactly. Then continue straight ahead and turn left at the second street.\nTourist: At the second street on the left?\nLocal: Yes. The town centre is opposite the church. You can't miss it.\nTourist: Thank you very much. You're very kind!"
        },
        vocabGloss: [
