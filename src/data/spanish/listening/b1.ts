...
export const b1Listening: ListeningExercise[] = [
  {
    ...
    script:
      "Entrevistador: Hola, Claudia. Cuéntanos, ¿cómo fue tu año sabático?\n\nClaudia: Fue una experiencia increíble. Después de terminar el bachillerato, decidí tomarme un año antes de empezar la universidad. Mis padres estaban un poco preocupados al principio, pero al final me apoyaron.\n\nEntrevistador: ¿Adónde fuiste?\n\nClaudia: Viajé por varios países de Sudamérica. Empecé en Colombia, luego fui a Ecuador y Perú. Viví tres meses en una comunidad indígena cerca de Cusco, donde trabajé como voluntaria en un proyecto de educación para niños.\n\nEntrevistador: ¿Qué fue lo más difícil?\n\nClaudia: Adaptarme a vivir sin comodidades modernas. No había internet estable y a veces el frío era muy intenso. Pero aprendí a valorar las cosas simples de la vida. También mejoré mucho mi español, porque en la comunidad solo hablaban español y quechua.\n\nEntrevistador: ¿Recomendarías este tipo de experiencia a otros jóvenes?\n\nClaudia: Sin duda. Me cambió la forma de ver el mundo. Ahora empiezo los estudios de medicina con una perspectiva mucho más amplia y sé por qué quiero ayudar a las personas.",
    translation:
      "Interviewer: Hi, Claudia. Tell us, how was your gap year?\n\nClaudia: It was an incredible experience. After finishing secondary school, I decided to take a year off before starting university. My parents were a little worried at first, but in the end they supported me.\n\nInterviewer: Where did you go?\n\nClaudia: I traveled through several countries in South America. I started in Colombia, then went to Ecuador and Peru. I lived three months in an indigenous community near Cusco, where I worked as a volunteer in an education project for children.\n\nInterviewer: What was the hardest part?\n\nClaudia: Adapting to living without modern comforts. There was no stable internet and sometimes the cold was very intense. But I learned to appreciate the simple things in life. I also improved my Spanish a lot, because in the community they only spoke Spanish and Quechua.\n\nInterviewer: Would you recommend this kind of experience to other young people?\n\nClaudia: Without a doubt. It changed the way I see the world. Now I'm starting my medical studies with a much broader perspective and I know why I want to help people.",
    questions: [
      {
        id: "es-l-b1-1-q1",
        level: "B1",
  ...
  },
  {
    ...
    script:
      "Andrés: Oye, Laura, ¿cómo va la búsqueda de trabajo? Llevas ya un par de meses buscando, ¿no?\n\nLaura: Sí, y la verdad es que está siendo bastante complicado. He mandado como treinta currículums y solo me han llamado para cuatro entrevistas.\n\nAndrés: ¿Y qué tal las entrevistas?\n\nLaura: Dos fueron bien, pero al final eligieron a otros candidatos con más experiencia. El problema es que tengo el título, pero poca experiencia laboral real. Es el círculo vicioso de siempre: para conseguir experiencia necesitas trabajo, y para conseguir trabajo necesitas experiencia.\n\nAndrés: ¿Has pensado en hacer prácticas mientras tanto?\n\nLaura: Sí, estoy considerando un puesto de prácticas en una empresa de marketing digital. No está muy bien pagado, pero al menos podría añadir algo al currículum y hacer contactos en el sector.\n\nAndrés: Me parece una buena idea. Yo también pasé por eso. Al final, lo que más me ayudó fue el networking. Fui a eventos del sector y así conocí al jefe de mi empresa actual.\n\nLaura: Tienes razón. Creo que también debería mejorar mi perfil de LinkedIn y empezar a ir a esos eventos. ¿Me recomiendas alguno?\n\nAndrés: Claro. El próximo mes hay una jornada de empleo en el centro de negocios. Te paso el enlace.",
    translation:
      "Andrés: Hey, Laura, how's the job search going? You've been looking for a couple of months now, right?\n\nLaura: Yes, and to be honest it's been quite complicated. I've sent around thirty CVs and they've only called me for four interviews.\n\nAndrés: And how did the interviews go?\n\nLaura: Two went well, but in the end they chose other candidates with more experience. The problem is that I have the degree, but little real work experience. It's the same old vicious circle: to get experience you need a job, and to get a job you need experience.\n\nAndrés: Have you thought about doing an internship in the meantime?\n\nLaura: Yes, I'm considering an internship position at a digital marketing company. It doesn't pay very well, but at least I could add something to my CV and make contacts in the sector.\n\nAndrés: That sounds like a good idea. I went through the same thing. In the end, what helped me most was networking. I went to industry events and that's how I met the boss of my current company.\n\nLaura: You're right. I think I should also improve my LinkedIn profile and start going to those events. Can you recommend any?\n\nAndrés: Of course. Next month there's a jobs fair at the business center. I'll send you the link.",
    questions: [
      {
        id: "es-l-b1-3-q1",
        level: "B1",
