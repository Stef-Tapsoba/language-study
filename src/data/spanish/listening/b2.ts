...
export const b2Listening: ListeningExercise[] = [
    ...
    },
    {
        ...
        script: "Moderadora: Esta noche debatimos sobre la política de inmigración en España. Primero, la señora Vega. Señora Vega: La inmigración es una realidad inevitable y, en muchos casos, necesaria para sostener nuestra economía. España tiene una tasa de natalidad muy baja y necesita mano de obra para cubrir puestos en sectores como la agricultura, la hostelería y el cuidado de personas mayores. Señor Ramos: Estoy de acuerdo en que necesitamos una política migratoria ordenada, pero no podemos ignorar los problemas de integración. Una llegada masiva sin recursos suficientes genera tensión social y puede perjudicar tanto a los ciudadanos locales como a los propios inmigrantes. Moderadora: ¿Cómo garantizar entonces una integración exitosa? Señora Vega: Invirtiendo en programas de acogida, formación lingüística y reconocimiento de cualificaciones extranjeras.",
        translation: "Moderator: Tonight we debate immigration policy in Spain. First, Ms Vega. Ms Vega: Immigration is an inevitable reality and, in many cases, necessary to sustain our economy. Spain has a very low birth rate and needs workers to fill positions in sectors such as agriculture, hospitality and care of the elderly. Mr Ramos: I agree that we need an orderly migration policy, but we cannot ignore integration problems. A massive arrival without sufficient resources generates social tension and can harm both local citizens and the immigrants themselves. Moderator: How do we guarantee successful integration, then? Ms Vega: By investing in reception programmes, language training and recognition of foreign qualifications.",
        questions: [
            {
                id: "es-l-b2-3-q1",
                level: "B2",
