...
// 23 ordered A1 units for Spanish.
//
...
// U22: Adverbs, Frequency & Connectors (new)
// U23: Bridge — Ir a + Infinitive (renumbered from U17 — stays last as A2 bridge)
...
export const a1Units: LessonUnit[] = [
    ...
    },
    {
        ...
        verbIds: [],
        testQuestions: [
            { id: "es-uq-a1-18-1", level: "A1", prompt: "How do you say 'My name is Carlos'?", options: ["Me llamo Carlos.", "Yo llamo Carlos.", "Soy llamado Carlos.", "Tengo nombre Carlos."], answer: "Me llamo Carlos." },
            { id: "es-uq-a1-18-2", level: "A1", prompt: "Complete: 'Ella ___ levanta a las siete.'", options: ["me", "te", "se", "nos"], answer: "se" },
            { id: "es-uq-a1-18-3", level: "A1", prompt: "Where does the reflexive pronoun go with a conjugated verb?", options: ["After the verb", "Before the conjugated verb", "At the end of the sentence", "After the subject"], answer: "Before the conjugated verb" },
            { id: "es-uq-a1-18-4", level: "A1", prompt: "Complete: 'Nosotros ___ acostamos tarde.'", options: ["me", "te", "se", "nos"], answer: "nos" },
            { id: "es-uq-a1-18-5", level: "A1", prompt: "What does 'ducharse' mean?", options: ["to eat", "to sleep", "to shower", "to get dressed"], answer: "to shower" },
            { id: "es-uq-a1-18-6", level: "A1", prompt: "How do you ask 'What time do you wake up?'", options: ["¿A qué hora te duermes?", "¿A qué hora te despiertas?", "¿A qué hora te levantas aquí?", "¿Cuándo te duchas?"], answer: "¿A qué hora te despiertas?" },
        ]
    },
    {
        id: "es-a1-u19",
        ...
        verbIds: [],
        testQuestions: [
            { id: "es-uq-a1-19-1", level: "A1", prompt: "How do you say 'I like Spanish'?", options: ["Gusto el español.", "Me gusta el español.", "Me gustan el español.", "Yo gusta español."], answer: "Me gusta el español." },
            { id: "es-uq-a1-19-2", level: "A1", prompt: "How do you say 'I like tapas'? (tapas = plural)", options: ["Me gusta las tapas.", "Me gustan las tapas.", "Gusto las tapas.", "Te gustan las tapas."], answer: "Me gustan las tapas." },
            { id: "es-uq-a1-19-3", level: "A1", prompt: "How do you ask 'Do you like football?' (informal)?", options: ["¿Gustas el fútbol?", "¿Te gusta el fútbol?", "¿Te gustan el fútbol?", "¿Le gusta el fútbol?"], answer: "¿Te gusta el fútbol?" },
            { id: "es-uq-a1-19-4", level: "A1", prompt: "What does 'No me gusta nada' mean?", options: ["I don't like it much", "I like it a lot", "I don't like it at all", "I like nothing"], answer: "I don't like it at all" },
            { id: "es-uq-a1-19-5", level: "A1", prompt: "Complete: 'Me ___ bailar.' (I like dancing)", options: ["gustan", "gusta", "gusto", "gustas"], answer: "gusta" },
            { id: "es-uq-a1-19-6", level: "A1", prompt: "What does 'Me encanta' mean compared to 'Me gusta'?", options: ["I don't like it", "I like it (same as gusta)", "I love it (stronger than gusta)", "I hate it"], answer: "I love it (stronger than gusta)" },
        ]
    },
    {
        id: "es-a1-u20",
        ...
        verbIds: [],
        testQuestions: [
            { id: "es-uq-a1-20-1", level: "A1", prompt: "Complete: '¿___ hablar más despacio?' (can you)", options: ["Debes", "Tienes que", "Puedes", "Quieres"], answer: "Puedes" },
            { id: "es-uq-a1-20-2", level: "A1", prompt: "What is the yo form of 'poder'?", options: ["podo", "puedo", "pode", "puede"], answer: "puedo" },
            { id: "es-uq-a1-20-3", level: "A1", prompt: "Complete: 'Tengo ___ trabajar mañana.'", options: ["a", "de", "que", "para"], answer: "que" },
            { id: "es-uq-a1-20-4", level: "A1", prompt: "Which expresses a stronger obligation: 'deber' or 'tener que'?", options: ["deber", "tener que", "they are the same", "neither"], answer: "tener que" },
            { id: "es-uq-a1-20-5", level: "A1", prompt: "What does 'No puedo venir esta noche' mean?", options: ["I don't want to come tonight", "I can't come tonight", "I don't have to come tonight", "I shouldn't come tonight"], answer: "I can't come tonight" },
            { id: "es-uq-a1-20-6", level: "A1", prompt: "Complete: 'Ella ___ llegar a tiempo.' (she should)", options: ["puede", "quiere", "debe", "va a"], answer: "debe" },
        ]
    },
    {
        id: "es-a1-u21",
    ...
    },
    {
        ...
        verbIds: [],
        testQuestions: [
            { id: "es-uq-a1-22-1", level: "A1", prompt: "What does 'todavía' mean?", options: ["already", "soon", "still / yet", "never"], answer: "still / yet" },
            { id: "es-uq-a1-22-2", level: "A1", prompt: "Where do frequency adverbs usually go?", options: ["Before the subject", "After the conjugated verb", "At the end of the sentence only", "Before the infinitive"], answer: "After the conjugated verb" },
            { id: "es-uq-a1-22-3", level: "A1", prompt: "What does 'allí' mean?", options: ["here", "nearby", "there / over there", "inside"], answer: "there / over there" },
            { id: "es-uq-a1-22-4", level: "A1", prompt: "Which connector means 'because'?", options: ["pero", "sino", "aunque", "porque"], answer: "porque" },
            { id: "es-uq-a1-22-5", level: "A1", prompt: "What does 'a veces' mean?", options: ["always", "never", "sometimes", "often"], answer: "sometimes" },
            { id: "es-uq-a1-22-6", level: "A1", prompt: "Put in order: Primero → ? → Finalmente", options: ["después", "pero", "porque", "también"], answer: "después" },
        ]
    },
    {
        id: "es-a1-u23",
        ...
        testQuestions: [
            { id: "es-uq-a1-23-1", level: "A1", prompt: "What does 'Voy a comer' mean?", options: ["I am eating.", "I ate.", "I am going to eat.", "I want to eat."], answer: "I am going to eat." },
            { id: "es-uq-a1-23-2", level: "A1", prompt: "How do you say 'She is going to study tomorrow'?", options: ["Ella estudia mañana.", "Ella va a estudiar mañana.", "Ella estudió mañana.", "Ella quiere estudiar mañana."], answer: "Ella va a estudiar mañana." },
            { id: "es-uq-a1-23-3", level: "A1", prompt: "Complete: 'Nosotros ___ a viajar el próximo verano.'", options: ["voy", "vas", "van", "vamos"], answer: "vamos" },
            { id: "es-uq-a1-23-4", level: "A1", prompt: "What does 'quiero viajar' mean?", options: ["I am travelling.", "I travelled.", "I want to travel.", "I am going to travel."], answer: "I want to travel." },
            { id: "es-uq-a1-23-5", level: "A1", prompt: "Complete: '¿Qué vas a ___ este fin de semana?' (do)", options: ["haces", "hago", "haciendo", "hacer"], answer: "hacer" },
            { id: "es-uq-a1-23-6", level: "A1", prompt: "How do you say 'They are going to come'?", options: ["Ellos quieren venir.", "Ellos van a venir.", "Ellos vienen.", "Ellos vendrán."], answer: "Ellos van a venir." }
        ]
    },
]