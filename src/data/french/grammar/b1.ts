...
export const b1Grammar: GrammarLesson[] = [
    {
        ...
        explanation: "The subjunctive is used in subordinate clauses (after 'que') following expressions of doubt, emotion, desire, necessity, and uncertainty. Form it with the ils/elles present tense stem + endings: -e, -es, -e, -ions, -iez, -ent. Common triggers: il faut que, vouloir que, douter que, être content que.",
        examples: [
    ...
    },
    {
        ...
        explanation: "The present conditional expresses what would happen under a condition. Form it with the future stem + imperfect endings (-ais, -ais, -ait, -ions, -iez, -aient). Irregular stems mirror the future: aller→ir-, avoir→aur-, être→ser-, faire→fer-, vouloir→voudr-.",
        examples: [
    ...
    },
    {
        ...
        explanation: "The imparfait and passé composé are often used together in the same sentence. The imparfait provides the background or ongoing state; the passé composé describes the specific event that occurred. Think of the imparfait as the scene-setting and the passé composé as the action that happened.",
        examples: [
    ...
    },
    {
        ...
        explanation: "Relative pronouns link two clauses. Qui replaces the subject of the relative clause (who/that). Que replaces the object (whom/that — elides to qu' before vowel). Dont replaces a noun preceded by de (of which/whose). Où replaces a location or point in time (where/when).",
        examples: [
    ...
    },
    {
        ...
        explanation: "The pluperfect expresses an action that had already occurred before another past action. Form it with avoir/être in the imparfait + past participle. Agreement rules for être are the same as in the passé composé.",
        examples: [
