...
export const a1PhraseLessons: PhraseLesson[] = [
  // ── fr-pl-a1-1 : U1 Greetings ────────────────────────────────────────────
  {
    ...
    miniDialogue: [
      { speaker: '', text: '— Bonjour !', translation: 'Hello!' },
      { speaker: '', text: '— Bonjour Monsieur, bienvenue.', translation: 'Hello sir, welcome.' },
      { speaker: '', text: '— Merci !', translation: 'Thank you!' },
    ],
    practiceQuestion: {
      id: 'fr-pl-a1-1-q1',
      level: 'A1',
      prompt: 'Which phrase would you use when walking into a bakery at 9 am?',
  ...
  // ── fr-pl-a1-2 : U1 Politeness essentials ────────────────────────────────
  {
    ...
    miniDialogue: [
      { speaker: '', text: "— Excusez-moi, s'il vous plaît !", translation: 'Excuse me, please!' },
      { speaker: '', text: '— Oui ?', translation: 'Yes?' },
      { speaker: '', text: '— Où est le café ?', translation: 'Where is the café?' },
      { speaker: '', text: "— Là-bas, à droite.", translation: 'Over there, on the right.' },
      { speaker: '', text: '— Merci beaucoup !', translation: 'Thank you very much!' },
      { speaker: '', text: '— De rien.', translation: "You're welcome." },
    ],
    practiceQuestion: {
      id: 'fr-pl-a1-2-q1',
      level: 'A1',
      prompt: 'You bump into someone in a supermarket aisle. What do you say?',
  ...
  // ── fr-pl-a1-3 : U1 Saying goodbye ──────────────────────────────────────
  {
    ...
    miniDialogue: [
      { speaker: '', text: '— Au revoir, bonne journée !', translation: 'Goodbye, have a good day!' },
      { speaker: '', text: '— Merci, vous aussi !', translation: 'Thank you, you too!' },
      { speaker: '', text: '— À bientôt !', translation: 'See you soon!' },
    ],
    practiceQuestion: {
      id: 'fr-pl-a1-3-q1',
      level: 'A1',
      prompt: "It's 8 pm and you're leaving a restaurant. What do you say to the host?",
  ...
  // ── fr-pl-a1-4 : U2 My name (je m'appelle) ───────────────────────────────
  {
    ...
    miniDialogue: [
      { speaker: '', text: "— Comment tu t'appelles ?", translation: "What's your name?" },
      { speaker: '', text: "— Je m'appelle Sophie. Et toi ?", translation: 'My name is Sophie. And you?' },
      { speaker: '', text: "— Moi, c'est Lucas.", translation: "Me, I'm Lucas." },
    ],
    practiceQuestion: {
      id: 'fr-pl-a1-4-q1',
      level: 'A1',
      prompt: 'Someone asks "Comment tu t\'appelles ?" — which is the most natural reply?',
      options: ['Bonjour, je suis français.', "Je m'appelle Thomas.", 'Merci beaucoup.', 'Je viens de Paris.'],
      answer: "Je m'appelle Thomas.",
    },
    speakAloud:
  ...
  // ── fr-pl-a1-5 : U2 Where I'm from / nationality ─────────────────────────
  {
    ...
    miniDialogue: [
      { speaker: '', text: "— Tu es d'où ?", translation: 'Where are you from?' },
      { speaker: '', text: "— Je suis de New York. Je suis américaine. Et toi ?", translation: "I'm from New York. I'm American. And you?" },
      { speaker: '', text: '— Moi, je suis de Lyon. Je suis français.', translation: "Me, I'm from Lyon. I'm French." },
      { speaker: '', text: '— Ah, tu parles très bien anglais !', translation: 'Oh, you speak English very well!' },
    ],
    practiceQuestion: {
      id: 'fr-pl-a1-5-q1',
      level: 'A1',
      prompt: "You're female, from Madrid. How do you introduce your origin?",
      options: [
        "Je m'appelle Madrid.",
        'Je suis espagnol.',
      ...
      answer: 'Je suis de Madrid. Je suis espagnole.',
    },
    speakAloud:
  ...
  // ── fr-pl-a1-6 : U3 Numbers 1–30 ─────────────────────────────────────────
  {
    ...
    practiceQuestion: {
      id: 'fr-pl-a1-6-q1',
      level: 'A1',
      prompt: 'How do you say 18 in French?',
  ...
  // ── fr-pl-a1-7 : U3 Age phrases (j'ai X ans) ─────────────────────────────
  {
    ...
    miniDialogue: [
      { speaker: '', text: '— Tu as quel âge ?', translation: 'How old are you?' },
      { speaker: '', text: "— J'ai vingt-huit ans. Et toi ?", translation: "I'm 28. And you?" },
      { speaker: '', text: "— Moi, j'ai trente ans.", translation: "Me, I'm 30." },
      { speaker: '', text: '— Ah, tu es plus vieux que moi !', translation: "Oh, you're older than me!" },
    ],
    practiceQuestion: {
      id: 'fr-pl-a1-7-q1',
      level: 'A1',
      prompt: 'How do you say "I am 24 years old" in French?',
      options: [
  ...
  // ── fr-pl-a1-8 : U4 Jobs and professions ────────────────────────────────
  {
    ...
    miniDialogue: [
      { speaker: '', text: '— Tu fais quoi dans la vie ?', translation: 'What do you do for a living?' },
      { speaker: '', text: "— Je suis ingénieure. Et toi ?", translation: "I'm an engineer. And you?" },
      { speaker: '', text: "— Moi, je suis étudiant. J'étudie le droit.", translation: "Me, I'm a student. I study law." },
      { speaker: '', text: "— Ah, intéressant ! À quelle université ?", translation: 'Oh, interesting! At which university?' },
    ],
    practiceQuestion: {
      id: 'fr-pl-a1-8-q1',
      level: 'A1',
      prompt: "You're male and work as a journalist. How do you say this?",
      options: [
  ...
  // ── fr-pl-a1-9 : U4 Study and work phrases ──────────────────────────────
  {
    ...
    miniDialogue: [
      { speaker: '', text: '— Tu étudies quoi ?', translation: 'What do you study?' },
      { speaker: '', text: "— J'étudie l'architecture. Et toi, tu travailles ?", translation: 'I study architecture. And you, do you work?' },
      { speaker: '', text: '— Oui, je travaille dans un café le week-end.', translation: 'Yes, I work in a café on weekends.' },
      { speaker: '', text: "— C'est bien ! Tu aimes ça ?", translation: "That's good! Do you like it?" },
    ],
    practiceQuestion: {
      id: 'fr-pl-a1-9-q1',
      level: 'A1',
      prompt: 'How do you say "I study medicine at university"?',
      options: [
      ...
      answer: "J'étudie la médecine à l'université.",
    },
    speakAloud:
  ...
  // ── fr-pl-a1-10 : U5 Family vocabulary ──────────────────────────────────
  {
    ...
    miniDialogue: [
      { speaker: '', text: '— Tu as des frères et sœurs ?', translation: 'Do you have brothers and sisters?' },
      { speaker: '', text: "— Oui, j'ai un frère et deux sœurs. Et toi ?", translation: 'Yes, I have one brother and two sisters. And you?' },
      { speaker: '', text: '— Non, je suis fils unique.', translation: "No, I'm an only child." },
      { speaker: '', text: '— Vous êtes proches, ta famille et toi ?', translation: 'Are you close, you and your family?' },
      { speaker: '', text: '— Oui, très ! On se voit tous les dimanches.', translation: 'Yes, very! We see each other every Sunday.' },
    ],
    practiceQuestion: {
      id: 'fr-pl-a1-10-q1',
      level: 'A1',
      prompt: 'How do you say "I have three brothers"?',
      options: [
  ...
  // ── fr-pl-a1-11 : U5 Talking about family members ───────────────────────
  {
    ...
    miniDialogue: [
      { speaker: '', text: '— Tu as des enfants ?', translation: 'Do you have children?' },
      { speaker: '', text: "— Oui, j'ai deux fils. Mon fils aîné a huit ans et mon fils cadet a cinq ans. Et toi ?", translation: 'Yes, I have two sons. My eldest son is eight and my youngest is five. And you?' },
      { speaker: '', text: "— Pas encore ! Je suis trop jeune.", translation: "Not yet! I'm too young." },
    ],
    practiceQuestion: {
      id: 'fr-pl-a1-11-q1',
      level: 'A1',
      prompt: "Your friend (female) says her mother is from Lyon. How does she say it?",
      options: [
  ...
  // ── fr-pl-a1-12 : U7 Likes and dislikes ────────────────────────────────
  {
    ...
    miniDialogue: [
      { speaker: '', text: '— Tu aimes le sport ?', translation: 'Do you like sport?' },
      { speaker: '', text: "— J'adore ça ! J'aime beaucoup le tennis et je fais du vélo le week-end. Et toi ?", translation: 'I love it! I really like tennis and I cycle on weekends. And you?' },
      { speaker: '', text: "— Moi, je n'aime pas beaucoup le sport. Je préfère la musique.", translation: "Me, I don't like sport much. I prefer music." },
      { speaker: '', text: "— Ah oui ? Tu joues d'un instrument ?", translation: 'Oh really? Do you play an instrument?' },
      { speaker: '', text: '— Oui, je joue de la guitare.', translation: 'Yes, I play guitar.' },
    ],
    practiceQuestion: {
      id: 'fr-pl-a1-12-q1',
      level: 'A1',
      prompt: 'How do you say "I love travelling but I hate cooking"?',
      options: [
      ...
      answer: "J'adore voyager mais je déteste cuisiner.",
    },
    speakAloud:
  ...
  // ── fr-pl-a1-13 : U8 Where I live / habiter ─────────────────────────────
  {
    ...
    miniDialogue: [
      { speaker: '', text: '— Tu habites où exactement ?', translation: 'Where exactly do you live?' },
      { speaker: '', text: "— J'habite à Lyon, dans le centre-ville. Et toi ?", translation: 'I live in Lyon, in the city centre. And you?' },
      { speaker: '', text: "— Moi, j'habite en Belgique, près de Bruxelles. Mais je travaille en France.", translation: 'Me, I live in Belgium, near Brussels. But I work in France.' },
      { speaker: '', text: '— Ah, tu fais la navette ?', translation: 'Oh, you commute?' },
      { speaker: '', text: '— Oui, deux fois par semaine.', translation: 'Yes, twice a week.' },
    ],
    practiceQuestion: {
      id: 'fr-pl-a1-13-q1',
      level: 'A1',
      prompt: 'How do you say "I live in Japan"?',
      options: [
        "J'habite à Japon.",
        "J'habite en Japon.",
        "J'habite au Japon.",
  ...
  // ── fr-pl-a1-14 : U9 Describing home / il y a ───────────────────────────
  {
    ...
    miniDialogue: [
      { speaker: '', text: "— Tu habites dans une maison ou un appartement ?", translation: 'Do you live in a house or a flat?' },
      { speaker: '', text: "— J'habite dans un appartement au troisième étage. Il y a deux chambres, un salon et une petite cuisine.", translation: "I live in a flat on the third floor. There are two bedrooms, a living room and a small kitchen." },
      { speaker: '', text: '— Tu as un balcon ?', translation: 'Do you have a balcony?' },
      { speaker: '', text: "— Oui, et il y a une belle vue sur le parc !", translation: 'Yes, and there\'s a beautiful view of the park!' },
      { speaker: '', text: "— C'est sympa ! C'est grand ?", translation: "That's nice! Is it big?" },
    ],
    practiceQuestion: {
      id: 'fr-pl-a1-14-q1',
      level: 'A1',
      prompt: 'How do you say "There are three bedrooms in my house"?',
      options: [
      ...
      answer: 'Il y a trois chambres dans ma maison.',
    },
    speakAloud:
  ...
  // ── fr-pl-a1-15 : U10 Daily routine verbs ───────────────────────────────
  {
    ...
    miniDialogue: [
      { speaker: '', text: '— Tu as une routine le matin ?', translation: 'Do you have a morning routine?' },
      { speaker: '', text: "— Oui ! Je me lève à six heures et demie. Je me douche, je m'habille, et je prends un café. Je pars au travail à sept heures et demie.", translation: "Yes! I get up at half six. I shower, get dressed, and have a coffee. I leave for work at half seven." },
      { speaker: '', text: "— C'est tôt ! Moi, je suis plutôt du soir. Je me lève à neuf heures.", translation: "That's early! Me, I'm more of an evening person. I get up at nine." },
    ],
    practiceQuestion: {
      id: 'fr-pl-a1-15-q1',
      level: 'A1',
      prompt: 'How do you say "I shower every morning"?',
      options: [
      ...
      answer: 'Je me douche chaque matin.',
    },
    speakAloud:
  ...
  // ── fr-pl-a1-16 : U11 Telling the time ──────────────────────────────────
  {
    ...
    miniDialogue: [
      { speaker: '', text: "— Excusez-moi, vous avez l'heure ?", translation: 'Excuse me, do you have the time?' },
      { speaker: '', text: '— Oui, il est quinze heures moins le quart.', translation: "Yes, it's quarter to three." },
      { speaker: '', text: '— Pardon ?', translation: 'Sorry?' },
      { speaker: '', text: "— Deux heures et quart de l'après-midi.", translation: 'Quarter past two in the afternoon.' },
      { speaker: '', text: "— Ah merci ! Je suis en retard...", translation: "Oh thanks! I'm late..." },
    ],
    practiceQuestion: {
      id: 'fr-pl-a1-16-q1',
      level: 'A1',
      prompt: 'Someone says "Il est dix-neuf heures trente." What time is it?',
  ...
  // ── fr-pl-a1-17 : U15 Ordering food and drink ───────────────────────────
  {
    ...
    miniDialogue: [
      { speaker: '', text: '— Bonjour, vous avez choisi ?', translation: 'Hello, have you chosen?' },
      { speaker: '', text: "— Oui, je voudrais le plat du jour, s'il vous plaît.", translation: "Yes, I'd like the dish of the day, please." },
      { speaker: '', text: '— Très bien. Et comme boisson ?', translation: 'Very well. And to drink?' },
      { speaker: '', text: "— De l'eau, s'il vous plaît. Vous avez de l'eau gazeuse ?", translation: 'Water, please. Do you have sparkling water?' },
      { speaker: '', text: "— Bien sûr. Vous désirez autre chose ?", translation: 'Of course. Would you like anything else?' },
      { speaker: '', text: "— Non merci, c'est tout.", translation: "No thank you, that's all." },
    ],
    practiceQuestion: {
      id: 'fr-pl-a1-17-q1',
      level: 'A1',
      prompt: 'You want to order a beer politely. What do you say?',
      options: [
        'Je veux de la bière.',
      ...
      answer: "Je voudrais de la bière, s'il vous plaît.",
    },
    speakAloud:
  ...
  // ── fr-pl-a1-18 : U16 Shopping and prices ───────────────────────────────
  {
    ...
    miniDialogue: [
      { speaker: '', text: '— Bonjour ! Vous désirez ?', translation: "Hello! What would you like?" },
      { speaker: '', text: "— Bonjour ! Je voudrais du fromage, s'il vous plaît. Vous avez du comté ?", translation: "Hello! I'd like some cheese, please. Do you have comté?" },
      { speaker: '', text: "— Oui, bien sûr. Combien vous en voulez ?", translation: 'Yes of course. How much would you like?' },
      { speaker: '', text: "— Euh... deux cents grammes, s'il vous plaît.", translation: 'Um... two hundred grams, please.' },
      { speaker: '', text: '— Voilà. Et avec ça ?', translation: 'There you are. Anything else?' },
      { speaker: '', text: '— C\'est combien, ce camembert ?', translation: 'How much is this camembert?' },
      { speaker: '', text: '— Quatre euros cinquante la pièce.', translation: 'Four euros fifty each.' },
    ],
    practiceQuestion: {
      id: 'fr-pl-a1-18-q1',
      level: 'A1',
      prompt: 'How do you ask "How much does that come to?"',
      options: [
  ...
  // ── fr-pl-a1-19 : U17 Asking for and giving directions ──────────────────
  {
    ...
    miniDialogue: [
      { speaker: '', text: "— Pardon madame, excusez-moi !", translation: 'Excuse me, madam!' },
      { speaker: '', text: "— Je cherche le musée des Beaux-Arts. Vous savez où c'est ?", translation: "I'm looking for the Fine Arts Museum. Do you know where it is?" },
      { speaker: '', text: "— Oui, c'est par là. Vous allez tout droit jusqu'aux feux, vous tournez à gauche, et c'est la deuxième rue à droite. C'est à cinq minutes à pied environ.", translation: "Yes, it's that way. You go straight ahead to the traffic lights, turn left, and it's the second street on the right. It's about five minutes on foot." },
      { speaker: '', text: '— Pardon, vous pouvez répéter plus lentement ?', translation: 'Sorry, can you repeat more slowly?' },
      { speaker: '', text: '— Merci beaucoup !', translation: 'Thank you very much!' },
    ],
    practiceQuestion: {
      id: 'fr-pl-a1-19-q1',
      level: 'A1',
      prompt: 'Someone says "Prenez la deuxième rue à gauche." What do you do?',
      options: [
      ...
      answer: 'Take the second street on the left',
    },
    speakAloud:
  ...
  // ── fr-pl-a1-20 : U18 Making plans, dates, and months ───────────────────
  {
    ...
    miniDialogue: [
      { speaker: '', text: '— Salut ! Tu es libre vendredi soir ?', translation: "Hi! Are you free Friday evening?" },
      { speaker: '', text: "— Vendredi... oui, je crois. Pourquoi ?", translation: "Friday... yes, I think so. Why?" },
      { speaker: '', text: "— Il y a un concert de jazz au Petit Journal. Ça te dit ?", translation: "There's a jazz concert at the Petit Journal. Fancy it?" },
      { speaker: '', text: "— Ah oui, bonne idée ! C'est à quelle heure ?", translation: 'Oh yes, good idea! What time is it?' },
      { speaker: '', text: "— Ça commence à vingt heures trente. On se retrouve devant à vingt heures ?", translation: "It starts at 8:30. Shall we meet outside at 8?" },
      { speaker: '', text: "— Parfait ! À vendredi !", translation: "Perfect! See you Friday!" },
    ],
    practiceQuestion: {
      id: 'fr-pl-a1-20-q1',
      level: 'A1',
      prompt: 'Your friend asks if you want to come to dinner. How do you say "Good idea, I\'m in!"?',
      options: [
      ...
      answer: "Bonne idée, je suis partant !",
    },
    speakAloud:
