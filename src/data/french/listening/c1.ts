...
export const c1Listening: ListeningExercise[] = [
    {
        ...
        dialogue: [
            { speaker: "Modérateur", text: "Notre table ronde de ce soir porte sur les enjeux éthiques de l'intelligence artificielle.", translation: "Tonight's round table focuses on the ethical challenges of artificial intelligence." },
            { speaker: "Premier intervenant", text: "Force est de constater que le développement des algorithmes décisionnels soulève des questions fondamentales en matière de responsabilité. Lorsqu'un système d'IA commet une erreur — médicale, judiciaire ou financière —, qui doit en répondre ? Le concepteur, l'utilisateur ou la machine elle-même ?", translation: "One cannot but acknowledge that the development of decision-making algorithms raises fundamental questions of responsibility. When an AI system makes an error — medical, judicial or financial — who is accountable? The designer, the user or the machine itself?" },
            { speaker: "Deuxième intervenant", text: "À cet égard, la notion de transparence algorithmique est centrale. Dans la mesure où les décisions automatisées restent opaques pour les individus qu'elles affectent, on peut légitimement parler d'une violation des principes démocratiques fondamentaux. Il convient donc d'imposer des obligations d'explicabilité aux systèmes d'IA déployés dans les secteurs sensibles.", translation: "In this regard, the notion of algorithmic transparency is central. Insofar as automated decisions remain opaque to the individuals they affect, one can legitimately speak of a violation of fundamental democratic principles. It is therefore appropriate to impose explicability obligations on AI systems deployed in sensitive sectors." },
            { speaker: "Troisième intervenant", text: "Nonobstant ces préoccupations légitimes, il ne faudrait pas céder à une vision purement dystopique. L'IA, bien encadrée par un cadre réglementaire robuste, peut contribuer à réduire les biais humains dans des domaines tels que le recrutement ou la justice. Au demeurant, l'Union européenne travaille précisément à l'élaboration d'un tel cadre juridique contraignant.", translation: "Notwithstanding these legitimate concerns, we must not give in to a purely dystopian vision. AI, properly framed by a robust regulatory framework, can help reduce human biases in areas such as recruitment or justice. Moreover, the European Union is working precisely on the elaboration of such a binding legal framework." },
        ],
        questions: [
            {
                id: "fr-l-c1-1-q1",
    ...
    },
    {
        ...
        dialogue: [
            { speaker: "Journaliste", text: "Votre dernier roman aborde frontalement la question du racisme systémique en France. Écrire est-il pour vous un acte politique ?", translation: "Your latest novel directly addresses the question of systemic racism in France. Is writing a political act for you?" },
            { speaker: "Écrivain", text: "Il va de soi que l'écriture ne saurait être neutre. Chaque choix stylistique, chaque prise de position narrative est en soi un geste éthique. Cela dit, je me méfie du terme 'littérature engagée' au sens sartrien strict, car il risque de réduire l'œuvre à son message au détriment de sa dimension esthétique.", translation: "It goes without saying that writing cannot be neutral. Every stylistic choice, every narrative stance is in itself an ethical gesture. That said, I am wary of the term 'committed literature' in the strict Sartrean sense, as it risks reducing the work to its message at the expense of its aesthetic dimension." },
            { speaker: "Journaliste", text: "Comment conciliez-vous ambition littéraire et nécessité politique ?", translation: "How do you reconcile literary ambition with political necessity?" },
            { speaker: "Écrivain", text: "En m'en tenant précisément à la singularité des destins individuels. Ce n'est pas en produisant un discours idéologique que l'on émeut et l'on convainc, mais en donnant à voir la complexité vécue d'une existence. La littérature a cette capacité que n'a pas le pamphlet : elle suscite l'empathie cognitive, elle oblige le lecteur à habiter une subjectivité qui n'est pas la sienne.", translation: "By confining myself precisely to the singularity of individual destinies. It is not by producing an ideological discourse that one moves and convinces, but by showing the lived complexity of an existence. Literature has a capacity that the pamphlet does not: it generates cognitive empathy, it obliges the reader to inhabit a subjectivity that is not their own." },
            { speaker: "Journaliste", text: "Vous invoquez souvent Fanon et Césaire. Qu'est-ce que ces penseurs vous ont appris ?", translation: "You often invoke Fanon and Césaire. What did these thinkers teach you?" },
            { speaker: "Écrivain", text: "Ils m'ont appris que la langue peut être à la fois l'instrument de l'oppression et l'outil de son dépassement. Force est de constater que s'emparer de la langue du colonisateur pour la retourner contre lui reste l'un des gestes les plus subversifs qui soit.", translation: "They taught me that language can be both the instrument of oppression and the tool for overcoming it. One cannot but acknowledge that seizing the language of the coloniser in order to turn it against them remains one of the most subversive gestures possible." },
        ],
        questions: [
            {
                id: "fr-l-c1-3-q1",
    ...
    },
    {
        ...
        dialogue: [
            { speaker: "Journaliste", text: "Bonsoir. Ce soir, nous nous interrogeons sur l'avenir de la démocratie libérale à l'heure où les régimes autoritaires semblent gagner du terrain sur tous les continents.", translation: "Good evening. Tonight we are asking about the future of liberal democracy at a time when authoritarian regimes appear to be gaining ground on every continent." },
            { speaker: "Politologue", text: "Il est à noter que la démocratie libérale a toujours été un système fragile, qui suppose des conditions sociales, économiques et culturelles favorables à son maintien. Or, la montée des inégalités, la défiance envers les institutions et la polarisation du débat public constituent des facteurs de fragilisation dont il serait imprudent de sous-estimer la portée.", translation: "It should be noted that liberal democracy has always been a fragile system, which presupposes social, economic and cultural conditions favourable to its maintenance. Now, rising inequalities, distrust of institutions and the polarisation of public debate constitute factors of fragility whose significance would be imprudent to underestimate." },
            { speaker: "Journaliste", text: "Faut-il pour autant parler de crise terminale de la démocratie ?", translation: "Should we therefore speak of a terminal crisis of democracy?" },
            { speaker: "Politologue", text: "Non, et je serais prudent face aux analyses catastrophistes. Il n'empêche que les signaux d'alerte sont réels. Ce que l'on observe, c'est moins un rejet de la démocratie en tant que valeur que de ses modalités concrètes de fonctionnement : la distance entre représentants et représentés, la lenteur des processus délibératifs face à l'urgence des crises, et la perméabilité du débat public aux manipulations informationnelles. Dans la mesure où ces dysfonctionnements ne sont pas corrigés, ils risquent d'alimenter un populisme qui, en se réclamant de la volonté du peuple, vide en réalité la démocratie de sa substance procédurale.", translation: "No, and I would be cautious in the face of catastrophist analyses. The fact remains that the warning signs are real. What we observe is less a rejection of democracy as a value than of its concrete modes of functioning: the distance between representatives and represented, the slowness of deliberative processes in the face of the urgency of crises, and the permeability of public debate to informational manipulations. Insofar as these dysfunctions are not corrected, they risk fuelling a populism which, while claiming to represent the will of the people, in reality empties democracy of its procedural substance." },
        ],
        questions: [
            {
                id: "fr-l-c1-4-q1",
