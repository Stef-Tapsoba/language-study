...
export const a1Vocab: VocabItem[] = [
    ...
    { id: "fr-v-a1-257", level: "A1", word: "Appelez le SAMU / les pompiers / la police", translation: "Call the ambulance / fire brigade / police (SAMU 15, pompiers 18, police 17)", category: "Health", example: { native: "Appelez le SAMU, s'il vous plaît — c'est urgent!", translation: "Call an ambulance, please — it's urgent!" } },
