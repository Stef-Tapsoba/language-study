...
export const b1Units: LessonUnit[] = [
...

    {
        ...
        description: "Tell complex, layered stories using passé composé, imparfait, and plus-que-parfait together naturally; express duration in the past with depuis + imparfait; and handle the meaning shift of devoir/pouvoir/vouloir between imparfait and passé composé.",
        grammarIds: ["fr-g-b1-16", "fr-g-b1-17"],
        ...
        testQuestions: [
            ...
            { id: "fr-b1-u2-q3", level: "B1", prompt: "Complete: 'J'___ depuis une heure quand il est finalement arrivé.'", options: ["attendais", "ai attendu", "avais attendu", "attendrai"], answer: "attendais" },
            { id: "fr-b1-u2-q4", level: "B1", prompt: "'Je devais partir à dix heures, mais j'ai raté mon train.' What does 'devais' imply?", options: ["I had to leave (and I did)", "I was supposed to leave (unrealised obligation)", "I will have to leave", "I should have left"], answer: "I was supposed to leave (unrealised obligation)" },
            { id: "fr-b1-u2-q5", level: "B1", prompt: "'Finalement, j'ai pu le convaincre.' What does 'j'ai pu' (passé composé of pouvoir) mean here?", options: ["I was able to (ongoing ability)", "I managed to convince him (concrete achievement)", "I could have convinced him", "I was allowed to convince him"], answer: "I managed to convince him (concrete achievement)" },
        ],
    },

    {
        ...
        testQuestions: [
            ...
            { id: "fr-b1-u3-q5", level: "B1", prompt: "'Il était entouré ___ ses amis.' Which agent marker is correct?", options: ["par", "de", "avec", "à"], answer: "de" },
        ],
    },
...

    {
        ...
        description: "Express emotion, doubt, and uncertainty with the subjunctive; master the indicative/subjunctive contrast with belief verbs; and use the subjonctif passé for subordinate events that happened before the main clause.",
        grammarIds: ["fr-g-b1-4", "fr-g-b1-18"],
        vocabIds: ["fr-v-b1-016", "fr-v-b1-017", "fr-v-b1-046", "fr-v-b1-050", "fr-v-b1-076"],
        verbIds: [],
        topicTags: ["social", "identity"],
        testQuestions: [
            { id: "fr-b1-u5-q1", level: "B1", prompt: "'Je pense qu'il est là' vs 'Je ne pense pas qu'il soit là.' Why does the second use subjunctive?", options: ["Because it's in the past", "Because the negation creates doubt", "Because penser always takes subjunctive", "Because 'là' triggers it"], answer: "Because the negation creates doubt" },
            { id: "fr-b1-u5-q2", level: "B1", prompt: "Which expression requires subjunctive?", options: ["Il est certain que", "Je sais que", "Il est possible que", "Il est évident que"], answer: "Il est possible que" },
            { id: "fr-b1-u5-q3", level: "B1", prompt: "Complete: 'Il est étrange qu'il n'___ pas répondu.' (past event)", options: ["a", "ait", "avait", "aura"], answer: "ait" },
            { id: "fr-b1-u5-q4", level: "B1", prompt: "'Je suis content qu'il ___ ce soir.' (he is coming tonight — future event) Which form is correct?", options: ["soit venu", "vienne", "venait", "viendra"], answer: "vienne" },
            { id: "fr-b1-u5-q5", level: "B1", prompt: "'Je suis content qu'il ___ hier.' (he came yesterday — past event) Which form is correct?", options: ["vienne", "venait", "soit venu", "viendra"], answer: "soit venu" },
        ],
    },
...

    {
        ...
        testQuestions: [
            ...
            { id: "fr-b1-u7-q4", level: "B1", prompt: "Complete: 'C'est l'unique solution qui ___ possible.' (superlative + subjunctive)", options: ["est", "soit", "sera", "serait"], answer: "soit" },
...

    {
        ...
        description: "Speculate about the present and regret the past using si clauses types 2 and 3 and the conditionnel passé; and express sequenced future actions with the futur antérieur (quand tu auras fini...).",
        grammarIds: ["fr-g-b1-7", "fr-g-b1-19"],
        ...
        testQuestions: [
            ...
            { id: "fr-b1-u8-q4", level: "B1", prompt: "Complete: 'Appelle-moi dès que tu ___ arrivé(e).' (futur antérieur)", options: ["es", "seras", "serais", "sois"], answer: "seras" },
            { id: "fr-b1-u8-q5", level: "B1", prompt: "'Il n'est pas là — il aura oublié.' What does the futur antérieur express here?", options: ["A future action before another future action", "A supposition about what probably happened", "A regret about the past", "A conditional result"], answer: "A supposition about what probably happened" },
        ],
    },

    {
        ...
        description: "Combine direct and indirect object pronouns; master pronoun ordering rules and double pronouns in affirmative and negative imperatives.",
        ...
        testQuestions: [
            ...
            { id: "fr-b1-u9-q4", level: "B1", prompt: "Negative imperative: 'Ne ___ ___ dis pas.' (the book — to him)", options: ["le lui", "lui le", "les lui", "lui les"], answer: "le lui" },
...

    {
        ...
        description: "Connect complex ideas using dont, lequel, and abstract ce qui/ce que/ce dont; and emphasise elements with cleft sentences (c'est...qui / c'est...que).",
        grammarIds: ["fr-g-b1-9", "fr-g-b1-20"],
        ...
        testQuestions: [
            ...
            { id: "fr-b1-u10-q4", level: "B1", prompt: "Emphasise the subject: 'Paul a tout organisé.' →", options: ["C'est Paul que a tout organisé.", "C'est Paul qui a tout organisé.", "Paul c'est qui a tout organisé.", "C'est Paul qu'a tout organisé."], answer: "C'est Paul qui a tout organisé." },
            { id: "fr-b1-u10-q5", level: "B1", prompt: "'Je t'attendais.' Emphasise 'toi' using a cleft sentence →", options: ["C'est toi qui j'attendais.", "C'est toi que j'attendais.", "C'est moi qui t'attendais.", "Toi c'est que j'attendais."], answer: "C'est toi que j'attendais." },
        ],
    },
...

    {
        ...
        description: "Express simultaneous actions, manner, and condition using en + present participle (gérondif); and express prior completed actions using the infinitif passé (après avoir/être + past participle).",
        grammarIds: ["fr-g-b1-11", "fr-g-b1-21"],
        ...
        testQuestions: [
            ...
            { id: "fr-b1-u12-q5", level: "B1", prompt: "Complete: 'Après ___ son travail, il est sorti.' (infinitif passé)", options: ["finir", "avoir fini", "finissant", "étant fini"], answer: "avoir fini" },
        ],
    },
...

    {
        ...
        description: "Express what you perceive someone doing and have things done using faire causatif and perception verbs; and use se faire + infinitif for having something done to or for oneself.",
        grammarIds: ["fr-g-b1-13", "fr-g-b1-22"],
        ...
        testQuestions: [
            ...
            { id: "fr-b1-u14-q5", level: "B1", prompt: "'Je me suis fait couper les cheveux.' What does this mean?", options: ["I cut my hair myself.", "I had my hair cut.", "I was cutting my hair.", "I am going to cut my hair."], answer: "I had my hair cut." },
        ],
    },
