...
export const b1Units: LessonUnit[] = [
    ...
    },
    {
        ...
        level: "B1",
        order: 2,
        title: "The Conditional & Advanced Future",
        description: "Use the condizionale presente for hypothetical situations and polite requests. Then extend the futuro semplice into two new B1 uses: expressing probability in the present ('Avrà trent'anni' = he's probably thirty) and future time clauses after quando, se, appena.",
        grammarIds: ["it-g-b1-2", "it-g-b1-5"],
