...
const module: LanguageModule = {
    grammar: [...a1Grammar, ...a2Grammar, ...b1Grammar, ...b2Grammar],
    vocab: [...a1Vocab, ...a2Vocab, ...b1Vocab, ...b2Vocab],
    verbs: [...a1Verbs, ...a2Verbs, ...b1Verbs, ...b2Verbs],
    units: [...a1Units, ...a2Units, ...b1Units, ...b2Units],
    placementQuestions,
    levelQuestions,
    readingPassages: [...a1Reading, ...a2Reading, ...b2Reading],
    listeningExercises: [...a1Listening, ...a2Listening, ...b2Listening]
}
