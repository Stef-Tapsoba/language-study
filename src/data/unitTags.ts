...
export const UNIT_TAGS: Record<string, TopicTag[]> = {
    ...
    // ── ITALIAN A2 ──────────────────────────────────────────────────────────────
    "it-a2-u1":  ["social", "identity"],
    "it-a2-u2":  ["social", "identity"],
    "it-a2-u3":  ["social", "culture"],
    "it-a2-u4":  ["social", "culture"],
    "it-a2-u5":  ["social", "identity"],
    "it-a2-u6":  ["social", "work"],
    "it-a2-u7":  ["social", "work"],
    "it-a2-u8":  ["social", "identity"],
    "it-a2-u9":  ["social", "work"],
    "it-a2-u10": ["work", "social"],
    "it-a2-u11": ["social", "travel"],
    "it-a2-u12": ["social", "work"],
    "it-a2-u13": ["health", "social"],
    "it-a2-u14": ["travel", "culture"],
    "it-a2-u15": ["social", "identity"],
    "it-a2-u16": ["social", "work"],
